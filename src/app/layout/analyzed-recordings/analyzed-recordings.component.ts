...
@Component({
    selector: 'app-analyzed-recordings',
    templateUrl: './analyzed-recordings.component.html',
    styleUrls: ['./analyzed-recordings.component.scss']
})
export class AnalyzedRecordingsComponent  implements OnInit, OnChanges {
    ...
    private loadPage() {
        ...
        this.repositoryService.getAnalyzedRecordingPage(this.page - 1, this.pageSize, this.filterComponent.recordingFilter).subscribe((d) => {
